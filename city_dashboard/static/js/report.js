...
function exportReport() {
  ...
  var ids = ["chart-weekly-consumption", "chart-monthly-cons", "chart-yearly-cons"];
  ...
  function generatePDF() {
    ...
    layout.content.push({
      "columns": [{
        "width": "50%",
        "image": charts["chart-weekly-consumption"].exportedImage,
        "fit": [250, 300]
      }, {
        "width": "*",
        "image": charts["chart-monthly-cons"].exportedImage,
        "fit": [250, 300]
      }],
      "columnGap": 10
    });
     ...
     layout.content.push({
      "image": charts["chart-yearly-cons"].exportedImage,
      "fit": [523, 300]
    });
